...
import { ENV_LIST_DJANGO_PYTHON_DEMO } from 'src/app/_models/common/common';
//
...
export class DjangoDemoComponent {
  //
  ...
  private GetData():void{
    // 1. get data 
    const pageSetting    = _environment.pageSettingDictionary[ENV_LIST_DJANGO_PYTHON_DEMO ];
