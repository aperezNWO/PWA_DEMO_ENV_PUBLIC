...
import { ENV_LIST_NETCORE_DEMO, ENV_LIST_NODEJS_DEMO } from 'src/app/_models/common/common';
...
export class NetcoredemoComponent  {
  ...
  private GetData():void{
    // 1. get data 
    const pageSetting    = _environment.pageSettingDictionary[ENV_LIST_NETCORE_DEMO];
